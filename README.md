...
> *Este jogo foi desenvolvido em Linguagem C como forma de avaliação parcial para o trabalho final do 1º ano do Curso Técnico em Informática, ofertado pelo *Instituto Federal do Paraná - Campus Colombo* em 2017.
> 
> Tal trabalho foi apresentado sob o nome **"Acessibilidade das pessoas com deficiências visuais na atualidade"**.*

### 👀 **Veja abaixo algumas capturas de tela deste jogo:** 👀

### 1) Imagem do menu principal
<img src="Screenshots/01.gif" width="75%">

### 2) Demonstração das letras em Braile, para que o(a) jogador(a) possa memorizá-las
<img src="Screenshots/02.gif" width="75%">

### 3) Demonstração de uma pergunta
<img src="Screenshots/03.gif" width="75%">

### 4) Exemplo do desempenho final do(a) jogador(a)
<img src="Screenshots/04.gif" width="75%">

### 5) Imagem contendo o link do GitHub do desenvolvedor
<img src="Screenshots/05.gif" width="75%">
